...
export const getUsers = async (req, res) => {
  try {
    const [results] = await pool.query('SELECT id, email, name, role, email_verified, setup_completed, documents_verified, created_at, phone, location, current_state, current_country, ip_address, is_active, bio, website, last_login, is_online, profile_image FROM users');
